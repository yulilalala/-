...
@SpringBootTest
public class GenderVoControllerTest {
	@Autowired
    ...
    public void testShow() throws Exception{
    	mvc.perform(MockMvcRequestBuilders.get("/showGender")//请求路径
    ...
    @Test
    public void testShowGender() throws Exception{
    	mvc.perform(MockMvcRequestBuilders.get("/course/showGender")//请求路径
                .contentType(MediaType.APPLICATION_JSON_UTF8)//访问数据类型
                .accept(MediaType.APPLICATION_JSON_UTF8)//接受数据类型
                .session(session)
        )
    ...
    @Test
    public void testShowAge() throws Exception{
    ...
    public void testShowProvince() throws Exception{
    	mvc.perform(MockMvcRequestBuilders.get("/province")//请求路径
                .contentType(MediaType.APPLICATION_JSON_UTF8)//访问数据类型
                .accept(MediaType.APPLICATION_JSON_UTF8)//接受数据类型
                .session(session)
        )
